...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  Future<void> _pickImage() async {
    ...
    if (kIsWeb) {
      ...
      setState(() {
        webImage = f;
        _pickedImage = File('a'); // Web uchun placeholder
      });
    } else {
      setState(() {
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            ...
            items: const [
              ...
              DropdownMenuItem(child: Text('Herbs'), value: 'Herbs'),
              DropdownMenuItem(child: Text('Spices'), value: 'Spices'),
            ],
          ),
        ),
      ),
